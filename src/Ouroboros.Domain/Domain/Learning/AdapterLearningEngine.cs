...
public sealed class AdapterLearningEngine : IAdapterLearningEngine
{
        ...
        CancellationToken ct = default)
    {
        try
        {
            ...
            Result<AdapterConfig, string> validationResult = config.Validate();
            ...
            double sizeInMb = sizeResult.Value / (1024.0 * 1024.0);
            if (sizeInMb > 10.0)
            {
        ...
        CancellationToken ct = default)
    {
        try
        {
            ...
            Result<TrainingConfig, string> configValidation = config.Validate();
            ...
            {
                Result<TrainingExample, string> exampleValidation = example.Validate();
        ...
        CancellationToken ct = default)
    {
        try
        {
            ...
            AdapterMetadata mergedMetadata = AdapterMetadata.Create(
                mergedId,
                $"merged_{strategy}",
        ...
        CancellationToken ct = default)
    {
        try
        {
            ...
            Result<FeedbackSignal, string> feedbackValidation = feedback.Validate();
            ...
            TrainingExample trainingExample = feedback.Type == FeedbackType.UserCorrection && feedback.Correction != null
