...
/// <summary>
/// Tests for the <see cref="SpeechRequest"/> record.
/// </summary>
[Trait("Category", "Unit")]
public class SpeechRequestTests
{
    ...
    public void Constructor_SetsAllProperties()
    {
        ...
        // Act
        var request = new SpeechRequest("Hello", "Ouroboros", tcs);
    ...
    {
        // Act
        var request = new SpeechRequest("Hello", "Ouroboros");
    ...
    {
        var a = new SpeechRequest("Hello", "Ouroboros");
        var b = new SpeechRequest("Hello", "Ouroboros");
    ...
    {
        var a = new SpeechRequest("Hello", "Ouroboros");
        var b = new SpeechRequest("Goodbye", "Ouroboros");
