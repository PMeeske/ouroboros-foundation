...
public class CausalMeTTaIntegrationAdditionalTests
{
    ...
    public void ConvertToMeTTa_MultipleVariablesAndEdges_IncludesAll()
    {
        ...
        result.Value.Should().Contain("discrete-variable");
    ...
    [InlineData(EdgeType.Indirect, "indirect")]
    ...
    [InlineData(VariableType.Discrete, "discrete")]
